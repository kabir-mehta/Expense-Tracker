...
export default function Expenses() {
  ...
  return (
    <div className="container mt-4">
        ...
        <tbody>
          {expenses.map(e => (
            <tr key={e.id}>
              ...
              <td>{e.description}</td>
              <td>
                <button className="btn btn-warning btn-sm me-2" onClick={() => { setForm(e); setEditingId(e.id); }}>Edit</button>
      ...
      <button className="btn btn-outline-success mt-3" onClick={handleExport}>⬇️ Export CSV</button>
      <br />
      <br />
