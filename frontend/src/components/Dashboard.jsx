...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      {/* Weekly Stats */}
      <h4 className="mb-3 mt-5">This Week</h4>
      <div className="row">
        <div className="col-md-3 mb-3">
          <div className="card shadow text-center p-3">
            <h5>Total This Week</h5>
            <p className="fw-bold text-success">₹{stats.total_this_week}</p>
          </div>
        </div>
        <div className="col-md-3 mb-3">
          <div className="card shadow text-center p-3">
            <h5>Top Category</h5>
            <p className="fw-bold text-primary">{stats.top_category_week || "N/A"}</p>
          </div>
        </div>
        <div className="col-md-3 mb-3">
          <div className="card shadow text-center p-3">
            <h5>Total Expenses</h5>
            <p className="fw-bold">{stats.total_expenses_week}</p>
          </div>
        </div>
        <div className="col-md-3 mb-3">
          <div className="card shadow text-center p-3">
            <h5>Avg Daily Spend</h5>
            <p className="fw-bold text-warning">₹{stats.avg_daily_week}</p>
          </div>
        </div>
      </div>
    </div>
